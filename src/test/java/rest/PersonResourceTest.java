...
public class PersonResourceTest {
    ...
    public void setUp() {
        ...
        r1 = new Role("user");
        r2 = new Role("admin");
        p1 = new Person("testperson1@hotmail.com", "secretpassword1", "11111111", "Kaj", "BÃ¸jesen");
        ...
        a1 = new Address("GÃ¸geholmvej 2", "HelsingÃ¸r", 3000);
        a2 = new Address("SlingrevÃ¦nget 55", "BirkerÃ¸d", 3460);
